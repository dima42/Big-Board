...
function convertToSlackChannel($fodder) {
	return	strtolower(substr(preg_replace("/[^a-zA-Z0-9]+/", "", $fodder),0,21));
};

function drawkwards_token() {
	return "xoxp-115681477587-116829918517-116066430608-c8e7080af7cb9da9893453c37a8e7e25";
}

function createNewSlackChannel($title) {
	// only use the first 21 characters
