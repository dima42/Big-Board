 ...
 */
abstract class PuzzleMember implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PuzzleMemberTableMap';
    ...
    /**
     * Compares this with another <code>PuzzleMember</code> instance.  If
     * <code>obj</code> is an instance of <code>PuzzleMember</code>, delegates to
     * <code>equals(PuzzleMember)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PuzzleMember The current object, for fluid interface
     */
    ...
    public function setPuzzleId($v)
    {
        ...
        if ($this->puzzle_id !== $v) {
            $this->puzzle_id = $v;
            $this->modifiedColumns[PuzzleMemberTableMap::COL_PUZZLE_ID] = true;
        }
    ...
    public function setMemberId($v)
    {
        ...
        if ($this->member_id !== $v) {
            $this->member_id = $v;
            $this->modifiedColumns[PuzzleMemberTableMap::COL_MEMBER_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PuzzleMemberTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPuzzleMemberQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PuzzleMember::setDeleted()
     * @see PuzzleMember::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPuzzleMemberQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PuzzleMemberTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
                if (!$this->isColumnModified(PuzzleMemberTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PuzzleMemberTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PuzzleMemberTableMap::COL_MEMBER_ID)) {
    ...
    {
        $pos = PuzzleMemberTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PuzzleMember'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PuzzleMemberTableMap::COL_CREATED_AT)) {
            $criteria->add(PuzzleMemberTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PuzzleMemberTableMap::COL_UPDATED_AT)) {
            $criteria->add(PuzzleMemberTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PuzzleMember (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PuzzleMember Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PuzzleMemberTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildPuzzleMember The current object (for fluent API support)
     */
