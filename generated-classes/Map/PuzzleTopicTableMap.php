...
/**
 * This class defines the structure of the 'puzzleTopic' table.
 *
 *
 *
...
class PuzzleTopicTableMap extends TableMap
{
     ...
     */
    const COL_PUZZLE_ID = 'puzzleTopic.puzzle_id';

    /**
     * the column name for the topic_id field
     */
    const COL_TOPIC_ID = 'puzzleTopic.topic_id';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'puzzleTopic.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'puzzleTopic.updated_at';
