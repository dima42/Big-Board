...
class LinkTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.LinkTableMap';
     ...
     */
    const COL_ID = 'link.id';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'link.title';

    /**
     * the column name for the url field
     */
    const COL_URL = 'link.url';

    /**
     * the column name for the external field
     */
    const COL_EXTERNAL = 'link.external';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Url', 'External', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'url', 'external', ),
        self::TYPE_COLNAME       => array(LinkTableMap::COL_ID, LinkTableMap::COL_TITLE, LinkTableMap::COL_URL, LinkTableMap::COL_EXTERNAL, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'url', 'external', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Url' => 2, 'External' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'url' => 2, 'external' => 3, ),
        self::TYPE_COLNAME       => array(LinkTableMap::COL_ID => 0, LinkTableMap::COL_TITLE => 1, LinkTableMap::COL_URL => 2, LinkTableMap::COL_EXTERNAL => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'url' => 2, 'external' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('title', 'Title', 'VARCHAR', true, 24, null);
        $this->addColumn('url', 'Url', 'VARCHAR', true, 255, null);
        $this->addColumn('external', 'External', 'BOOLEAN', true, 1, false);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LinkTableMap::COL_ID);
            $criteria->addSelectColumn(LinkTableMap::COL_TITLE);
            $criteria->addSelectColumn(LinkTableMap::COL_URL);
            $criteria->addSelectColumn(LinkTableMap::COL_EXTERNAL);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.url');
            $criteria->addSelectColumn($alias . '.external');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(LinkTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(LinkTableMap::COL_ID) && $criteria->keyContainsValue(LinkTableMap::COL_ID) ) {
